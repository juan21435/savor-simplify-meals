...
const ContinuousYearView = ({ currentDate, events, onEventClick }: ContinuousYearViewProps) => {
    ...
    <div className="w-full overflow-auto glass-morphism">
      ...
      <div className="divide-y divide-border/20">
        {months.map(month => {
          ...
          return (
            <div key={month.toString()} className="py-6">
              {/* Month label */}
              <h3 className="text-lg font-medium text-center mb-4 text-foreground/80">
